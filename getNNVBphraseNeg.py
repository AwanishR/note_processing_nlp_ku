...
print "NN-VB extractor running for negation ..."
fileTreeBankRead  = open ("testing/output/set4/neg_treeBank.txt","r")
verbOutFile = open ("testing/output/set4/neg_nnvb.txt","w")
noteNum = 1
