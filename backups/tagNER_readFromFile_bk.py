...
nounInFile = 'testing/output/set3/nnvb.txt'
finalOutputFile = 'Testing/output/set3/13000/NER_Output/finalout.tx'
totalMatch =0
def tagmedterm(text):
    ...
    for line in nounFile:
        ...
        for word in words:
            if "Note_Number" not in word:
                ...
                cur.execute("insert into "+tbl_name+" (note_id,detected_element,element_type,set_id,updated_date) values(%s,%s,%s,%s,%s)",
